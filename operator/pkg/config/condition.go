...
const (
	...
	CONDITION_MESSAGE_TOPIC_PARSED = "Kafka topic parsed"
)
...
const (
	...
	CONDITION_MESSAGE_GLOBALHUB_READY     = "Multicluster Global Hub is ready, All the components avaible"
	CONDITION_MESSAGE_GLOBALHUB_NOT_READY = "Multicluster Global Hub is not ready, Waiting all the components avaible"
	...
	CONDITION_MESSAGE_GLOBALHUB_UNINSTALL = "Multicluster Global Hub is Uninstalling"
)
