...
// +kubebuilder:rbac:groups=hive.openshift.io,resources=clusterdeployments,verbs=create;get;list;watch;update;patch
// +kubebuilder:rbac:groups=extensions.hive.openshift.io,resources=agentclusterinstalls,verbs=create;get;list;watch;update;patch
// +kubebuilder:rbac:groups=metal3.io,resources=baremetalhosts,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=metal3.io,resources=hostfirmwaresettings,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=agent-install.openshift.io,resources=infraenvs,verbs=create;delete;get;list;patch;update;watch
// +kubebuilder:rbac:groups=agent-install.openshift.io,resources=nmstateconfigs,verbs=create;delete;get;list;patch;update;watch
