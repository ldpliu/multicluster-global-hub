...
var supportAlertConfig = sets.NewString("groups", "policies", "contactPoints", "muteTimes", "templates", "resetPolicies")
var supportDeleteAlertConfig = sets.NewString("deleteRules", "deleteContactPoints", "deleteTemplates", "deleteMuteTimes")
...
func (r *MulticlusterGlobalHubReconciler) generateGrafanaIni(ctx context.Context, mgh *globalhubv1alpha4.MulticlusterGlobalHub) (bool, error) {
	...
	if customGrafanaIniSecret == nil {
		...
		mergedBytes, err = mergeGrafanaIni(defaultGrafanaIniSecret.Data[grafanaIniKey], customGrafanaIniSecret.Data[grafanaIniKey])
		if err != nil {
